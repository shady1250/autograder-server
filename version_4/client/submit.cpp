...
if(typeOfRequest==0){
	...
	char receive_type[size_int];
    	...
    	if(type==0){
    		...
    		printf("Request not found or wait for 1-2 mins then try again, it might not be in the queue but still being processed, as it would have popped out!\n");	
    	}
    	else if(type==3){
    		printf("Request is being processed please wait!\n");
    	}
    	else{
